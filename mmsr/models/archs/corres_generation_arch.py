...
class CorrespondenceGenerationArch(nn.Module):
    ...
    def forward(self, dense_features, img_ref_hr):    # contras_extractor_arch  -> dense_features
        batch_offset_relu3 = []
        batch_offset_relu2 = []
        batch_offset_relu1 = []
        flows_relu3 = []
        ...
        for ind in range(img_ref_hr.size(0)):
            feat_in = dense_features['dense_features1'][ind] # 40, 40
            feat_ref = dense_features['dense_features2'][ind] # 40, 40
            c, h, w = feat_in.size()
